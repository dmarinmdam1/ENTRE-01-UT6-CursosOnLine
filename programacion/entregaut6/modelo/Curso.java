...
public class Curso
{
    ...
    private String capitalizarNombre(String nombre) 
    {
        ...
        String[] palabrasSeparadas = nombre.split(ESPACIO);
        StringBuilder nombreFormateado = new StringBuilder();
        
        for(int i = 0 ; i < palabrasSeparadas.length ; i++)
        {
            nombreFormateado.append(Character.toUpperCase(palabrasSeparadas[i].charAt(0)));
            
            nombreFormateado.append(palabrasSeparadas[i].substring(1));
            
            if(i < palabrasSeparadas.length - 1)
            {
                nombreFormateado.append(ESPACIO);
            }
        }
